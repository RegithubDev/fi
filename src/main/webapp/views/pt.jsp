                                ...
                                <c:choose>
                                    ...
                                    <td data-label=upload_file>
                                       ...
                                       <c:when test="${not empty pt.upload_file}">
											    <c:forEach var="file" items="${fn:split(pt.upload_file, ',')}">
											      <span class="badge badge-light-dark"> 

                                           <a href="<%=CommonConstants.SAFETY_FILE_SAVING_PATH_LOC%>pt/${file}"
                ...
                <i class="fas fa-file-download me-1"></i>${file}
								   ...
								   <c:choose>
                                       <c:when test="${not empty pt.upload_file}">
											    <c:forEach var="file" items="${fn:split(pt.upload_file, ',')}">
											        <span class="badge badge-light-dark"> 
											    <i class="fa-solid fa-download"></i> <a href="<%=CommonConstants.SAFETY_FILE_SAVING_PATH_LOC%>pt/${file}" 
											           class="filevalue" 
											           target="_blank">
											           ${file}
											        </a></span><br/>
									...
									<td>
                                        ...
                                        <td data-label="Action">
                                            ...
                                            data-record-id="${pt.month_year}" 
								             		data-record-id1="${pt.profit_center_name}" 
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="remarks" rows="" placeholder="Enter remarks here...">${pt.remarks}</textarea>
                            </div>
                            <div class="col-md-6">
