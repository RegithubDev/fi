...
//						+ " ";
				String qry = "WITH Months AS (\r\n"
						...
						+ "    pc.profit_center_name,   -- ✅ Added name from master table\r\n"
						+ "    um.month_year,\r\n"
						+ "    um.user_id,\r\n"
						+ "    um.email_id,\r\n"
						+ "    CASE \r\n"
						...
						+ "      AND i.status = 'Active'\r\n"
						+ "LEFT JOIN [FIDB].[dbo].[profit_center] pc   -- ✅ Join to PC master\r\n"
						+ "       ON pc.profit_center_code = um.profit_center_code\r\n"
						+ "WHERE um.email_id IN (\r\n"
						+ "      'saidileep.p@resustainability.com',\r\n"
						+ "      'madhuri.s@resustainability.com'\r\n"
						+ ")\r\n"
