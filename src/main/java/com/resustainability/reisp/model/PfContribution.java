...
public String getEntity_codes() {
	return entity_codes;
}

public void setEntity_codes(String entity_codes) {
	this.entity_codes = entity_codes;
}
...
public String getProfit_center_codes() {
	return profit_center_codes;
}

public void setProfit_center_codes(String profit_center_codes) {
	this.profit_center_codes = profit_center_codes;
}

public String getProfit_center_names() {
	return profit_center_names;
}

public void setProfit_center_names(String profit_center_names) {
	this.profit_center_names = profit_center_names;
}

public String getMonth_years() {
	return month_years;
}

public void setMonth_years(String month_years) {
	this.month_years = month_years;
}
...
public String getVpfs() {
	return vpfs;
}

public void setVpfs(String vpfs) {
	this.vpfs = vpfs;
}
...
public String getPf_admins() {
	return pf_admins;
}

public void setPf_admins(String pf_admins) {
	this.pf_admins = pf_admins;
}

public String getPf_edlis() {
	return pf_edlis;
}

public void setPf_edlis(String pf_edlis) {
	this.pf_edlis = pf_edlis;
}
...
public String getPf_admin() {
	return pf_admin;
}

public void setPf_admin(String pf_admin) {
	this.pf_admin = pf_admin;
}

public String getPf_edli() {
	return pf_edli;
}

public void setPf_edli(String pf_edli) {
	this.pf_edli = pf_edli;
}
