...
public class IRM {
	...
	private String id,plant_name,pageIndex,CustomerCode,document_no,ActualVisitMonth,MSG,pull_datetime,plant,CustomerSAPCode,	level_code,project,document_code,maxRole,i_no_reviewer,maxRole2,mainStatus	,sb_notes,incident_type,email_id,role_code,all_irm,active_irm,inActive_irm,project_name,department_name,location_name,	email,description	,department_code,incident_name,user_id,	project_code	,location,	ptw_code	,
	...
	admin_incidents , i_pending ,i_completed,sb_rei_notes,person_location,reinitiate_date,sb_date,ca_before,pa_before,remarks_before,doc_before,type_prevs,approver_prvs,
		AC,NM,UA,UC,ACT,NMT,UAT,days_since_assigned,UCT,created_datetime,expired_datetime,document_code_files,TotalVisits,ActiveVistis,incativeVistis,customerId,
		Plantname,CustomerID,ActualMonthAndYear,	person_responsible,message,module_type	,doc,capa_id,rca_id,noCounts,tentative_date,investigation_team,base_role,
		base_department,daysNotLogined,incidents_count	,counts,ca,pa,level_status,	attachments,incident_types,	incident_seviourity,incident_category,	ua_type,	
		uc_type,	management_type,is_regularised	;
	...
	public String getDays_since_assigned() {
		return days_since_assigned;
	}

	public void setDays_since_assigned(String days_since_assigned) {
		this.days_since_assigned = days_since_assigned;
	}
